  ...
  return (
        <div className='border-2 rounded-lg md:flex mt-4 p-5'>
          ...
          <div className='md:flex md:flex-col'>
              ...
              <Link className='bg-[#F22E4B] w-full p-3 mb-5 text-white uppercase font-bold rounded-xl hover:cursor-pointer hover:bg-[#BF243C] transition-colors text-center' to={`/description/${code}`}>Ver más</Link>
          </div>
        </div>
    )
}
